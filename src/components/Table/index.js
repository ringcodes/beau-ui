  ...
  methods: {
    ...
    loadData (pagination, filters, sorter) {
      ...
      if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
        result.then(r => {
          this.initData(r.data.list, r.data.pageNumber, r.data.totalRow, pagination)
        })
      }
    },
    initData (list,page,total, pagination) {
      ...
      try {
        if ((['auto', true].includes(this.showPagination) && total <= (page * this.localPagination.pageSize))) {
